        ...
        <div class="slide" style="background-image:url({{$banner->image}});">
            <div class="container">
                <div class="slide-captions text-right">
                    <!-- Captions -->
                    <h2 class="text-lg">{{$banner->title}}</h2>
                    <a class="btn btn-light" href="#">{{$banner->action}}</a>
                    <a class="btn btn-light btn-outline" href="http://themeforest.net/item/polo-responsive-multipurpose-html5-template/13708923">{{$banner->description}}</a>
                    <!-- end: Captions -->
                </div>
            </div>
        </div>
        ...
        <div class="slide" style="background-image:url({{$banner->image}});">
            <div class="container">
                <div class="slide-captions">
                    <!-- Captions -->
                    <h2 class="text-lg text-dark">{{$banner->title}}</h2>
                    <a class="btn btn-dark" href="#">{{$banner->action}}</a>
                    <a class="btn btn-dark btn-outline" href="http://themeforest.net/item/polo-responsive-multipurpose-html5-template/13708923">{{$banner->description}}</a>
                    <!-- end: Captions -->
                </div>
            </div>
        </div>
