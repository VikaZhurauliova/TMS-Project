                ...
                <div class="row m-b-40">
                    <div class="col-lg-5">
                        <div class="product-image">
                            ...
                            <div class="carousel dots-inside dots-dark arrows-visible" data-items="1" data-loop="true" data-autoplay="true" data-animate-in="fadeIn" data-animate-out="fadeOut" data-autoplay="2500" data-lightbox="gallery">
                                <a href="{{asset('/images/shop/products/product-large.jpg')}}" data-lightbox="image" title="Shop product image!"><img alt="Shop product image!" src="images/shop/products/1.jpg">
                                </a>
                                <a href="{{asset('images/shop/products/product-large.jpg')}}" data-lightbox="image" title="Shop product image!"><img alt="Shop product image!" src="images/shop/products/2.jpg">
                                </a>
                            </div>
                            <!-- Carousel slider -->
                        </div>
                    ...
                    <div class="col-lg-7">
                        <div class="product-description">
                            ...
                            <div class="product-price"><ins>{{$products->price}}</ins>
                            </div>
                            ...
                            <div class="product-meta">
                                <p>Tags: <a href="#" rel="tag">{{$products->tag?->title(1)}}</a>, <a rel="tag" href="#">T-shirts</a>
                                </p>
                            </div>
                                ...
                                <div class="comment-list">
                                    ...
                                    <div class="comment" id="comment-1">
                                        ...
                                        <div class="text">
                                            ...
                                            <h5 class="name">{{$product->reviews?->name}}</h5>
