        ...
        <div class="row">
                ...
                <div class="shop">
                    <div class="grid-layout grid-3-columns" data-item="grid-item">
                        <div class="grid-item">
                            <div class="product">
                                <div class="product-image">
                                    <a href="#"><img alt="Shop product image!" src="{{'/images/shops/products/1.jpg'}}">
                                    </a>
                                    <a href="#"><img alt="Shop product image!" src="{{'/images/shops/products/10.jpg'}}">
                                    </a>
                        ...
                        <div class="grid-item">
                            <div class="product">
                                <div class="product-image">
                                    <a href="#"><img alt="Shop product image!" src="{{'images/shops/products/2.jpg'}}">
                                    </a>
                                    <a href="#"><img alt="Shop product image!" src="{{'images/shops/products/6.jpg'}}">
                                    </a>
                                    <span class="product-wishlist">
                                                <a href="#"><i class="fa fa-heart"></i></a>
                                            </span>
                        ...
                        <div class="grid-item">
                            <div class="product">
                                <div class="product-image">
                                    <a href="#"><img alt="Shop product image!" src="{{'images/shops/products/3.jpg'}}">
                                    </a>
                                    <a href="#"><img alt="Shop product image!" src="{{'images/shops/products/7.jpg'}}">
                                    </a>
                        ...
                        <div class="grid-item">
                            <div class="product">
                                <div class="product-image">
                                    <a href="#"><img alt="Shop product image!" src="{{'images/shops/products/4.jpg'}}">
                                    </a>
                                    <a href="#"><img alt="Shop product image!" src="{{'images/shops/products/9.jpg'}}">
                                    </a>
                                    <span class="product-wishlist">
                                                <a href="#"><i class="fa fa-heart"></i></a>
                                            </span>
                        ...
                        <div class="grid-item">
                            <div class="product">
                                <div class="product-image">
                                    <a href="#"><img alt="Shop product image!" src="{{'images/shops/products/5.jpg'}}">
                                    </a>
                                    <a href="#"><img alt="Shop product image!" src="{{'images/shops/products/11.jpg'}}">
                                    </a>
                                    <span class="product-wishlist">
                                                <a href="#"><i class="fa fa-heart"></i></a>
                                            </span>
                        ...
                        <div class="grid-item">
                            <div class="product">
                                <div class="product-image">
                                    <a href="#"><img alt="Shop product image!" src="{{'images/shops/products/8.jpg'}}">
                                    </a>
                                    <a href="#"><img alt="Shop product image!" src="{{'images/shops/products/1.jpg'}}">
                                    </a>
            ...
            <div class="sidebar sticky-sidebar col-lg-3">
                ...
                <div class="widget widget-shop">
                    ...
                    <div class="product">
                        <div class="product-image">
                            <a href="#"><img src="{{'images/shops/products/10.jpg'}}" alt="Shop product image!">
                            </a>
                        </div>
                        <div class="product-description">
                            <div class="product-category">Women</div>
                    ...
                    <div class="product">
                        <div class="product-image">
                            <a href="#"><img src="{{'images/shops/products/6.jpg'}}" alt="Shop product image!">
                            </a>
                        </div>
                        <div class="product-description">
                            <div class="product-category">Women</div>
                    ...
                    <div class="product">
                        <div class="product-image">
                            <a href="#"><img src="{{'images/shops/products/7.jpg'}}" alt="Shop product image!">
                            </a>
                        </div>
                        <div class="product-description">
                            <div class="product-category">Man</div>
